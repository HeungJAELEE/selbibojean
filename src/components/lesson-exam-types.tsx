  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm leading-6 text-slate-600">
        ...
        같은 중주제의 보충 문제와 모의문제는 비중 계산에서 제외하며,
        유형 카드는 문제 형태와 판단 대상만 보여줍니다.
      </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <h3 className="font-extrabold text-[#173957]">
                        {meta.label}
                      </h3>
                    ...
                    <p className="mt-2 text-xs font-black tracking-[.1em] text-slate-500">
                      판단 대상
                    </p>
