  ...
  return (
    <main className="page-wrap pb-16">
      ...
      <section className="mb-8 grid gap-4 rounded-3xl border border-[#c9e7df] bg-[#f5fcfa] p-5 sm:grid-cols-[auto_1fr] sm:items-center sm:p-6">
        ...
        <div>
          <p className="text-sm font-black text-[#143b43]">전체 이론 이관·통합 완료</p>
          <p className="mt-1 text-sm leading-6 text-slate-700">C001~C040 상세 페이지마다 이관한 원천 이론을 정의, 판단 규칙, 빈출 함정, 확인문제와 실기 코드까지 한 흐름으로 연결했습니다. C037~C040은 실기 코드·검수 확장으로 표시합니다.</p>
        </div>
      </section>
                ...
                return (
                  <article key={concept.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2 text-xs font-bold">
                      ...
                      <span className="rounded-full bg-teal-100 px-2.5 py-1 text-teal-800">통합 개념서 연결</span>
