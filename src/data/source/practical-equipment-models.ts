...
export const PRACTICAL_EQUIPMENT_MODELS: PracticalEquipmentModel[] = [
  ...
  },
  {
    ...
    currentSourceStatus: "facility_sheet",
    sourceUrl: null,
    learnerNote: "시설표 표기와 HAW 제품군을 대조하면 교류(AC) 계열이 유력합니다. 정확한 사양과 조작부는 명판에서 확인합니다.",
    welding: {
      ...
      verificationBasis: "시설표 표기와 HAW 교류 아크용접기 제품군을 대조",
      remainingCheck: "정확한 모델 사양과 전면 명판 확인",
    },
  },
  {
    id: "hanheung-haw-350",
  ...
  },
  {
    ...
    currentSourceStatus: "facility_sheet",
    sourceUrl: null,
    learnerNote: "2026 시설표에서 교류(AC) 장비로 확인됩니다. 세부 정격과 조작부는 현장 명판을 우선합니다.",
    welding: {
      ...
      outputCurrentType: "ac",
      outputVerification: "confirmed",
      verificationBasis: "2026 시험장 시설표의 교류 아크용접기 표기",
      remainingCheck: null,
    },
  },
  {
  ...
  },
  {
    ...
    currentSourceStatus: "needs_manual_check",
    sourceUrl: null,
    learnerNote: "CW-CTA3M의 전사 오류일 가능성이 있지만 시설표 문자열만으로 확정하지 않습니다. 복합기 여부와 아크 출력은 명판 확인이 필요합니다.",
    welding: {
      ...
      outputCurrentType: "ac",
      outputVerification: "probable",
      verificationBasis: "CW-CTA3M의 AC ARC 300A 사양과 표기 유사성을 대조",
      remainingCheck: "원본 표기는 보존하고 시험장 명판에서 전체 모델명 확인",
    },
  },
  {
    id: "postech-weltop-unknown-300a",
    ...
    currentSourceStatus: "needs_manual_check",
    sourceUrl: null,
    learnerNote: "시설표의 ‘웰탑300A’만으로는 AC300A와 WELTOP-ACDC300A를 구분할 수 없습니다. suffix를 확인하기 전에는 출력방식을 확정하지 않습니다.",
    welding: {
      ...
      verificationBasis: "포스테크에 AC 전용 300A와 AC/DC 겸용 300A 제품이 모두 존재",
      remainingCheck: "시험장 명판에서 AC300A 또는 WELTOP-ACDC300A 전체 모델명 확인",
    },
  },
  {
